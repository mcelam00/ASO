...
static int write_superblock(int fd) {
    struct assoofs_super_block_info sb = {
        ...
        .free_blocks = (~0) & ~(15), //operacion con la que comenzamos nuestra practica: hacemos el complemento a 1 de todo el mapa de bits (inicializado a 0) y quedan los 64 bits de la variable que representan los 64 bloques a 1 => libres
    };
    ssize_t ret;
